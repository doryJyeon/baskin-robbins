...
import { CompanyLink, CompanyLinks, CompanyLinks4Item, FooterWrapper, HappyLogos, LogoMenu, LogoWrapper, MenuWrapper, MobileFooterWrapper, SnsLogos, SnsWrapper } from './style';
  ...
  return (
    <footer>
      ...
      <MobileFooterWrapper>
        <LogoMenu>
          <LogoWrapper>
            <img className="mobile__logo" src="/m_images/logos/h_logo_2.png" alt="baskin robbins logo" />
