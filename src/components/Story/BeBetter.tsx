      ...
      <BetterWrapper>
        <Better>
          ...
          <div>
            ...
            <p className="small">
              핑크드림 캠페인은 브랜드와 소비자가 함께 도움이 필요한 이웃을 지원하는 사회공헌 활동입니다.
              배스킨라빈스는 2023년부터 핑크드림 캠페인의 일환으로 월드비전과 협업해 브랜드의 대표적 행사인 ‘31데이’ 수익의 3.1%를 기부금으로 적립하고 있습니다.
            </p>
            <ul className="pink">
        ...
        <Better>
          ...
          <div>
            ...
            <p className="small">
              핑크팜 캠페인은 배스킨라빈스와 지역농가 청년농부지원을 위한 콜라보레이션 상생 프로젝트 입니다.
        ...
        <Better>
          ...
          <div>
            ...
            <p className="small">
              핑크링크 캠페인은 배스킨라빈스에서 중소기업 지원을 위해 진행하는 콜라보레이션 상생 프로젝트입니다.
